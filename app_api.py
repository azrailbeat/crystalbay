...
def register_api_routes(app):
    ...
    @app.route('/api/samo/demo_search_success', methods=['POST'])
    def api_demo_search_success():
        """🎯 ДЕМО: Успешный поиск туров для сервера с белым IP"""
        try:
            data = request.get_json()
            townfrom = data.get('townfrom', 'Астана')
            adults = data.get('adults', 2)
            nights = data.get('nights', 7)
            
            # Симуляция успешного ответа SAMO API на основе реального формата данных
            demo_response = {
                "success": True,
                ...
                "tours": [
                    {
                        "id": "TR001",
                        "name": "Турция - Анталия",
                        "hotel": "Crystal Sunrise Queen Luxury Resort & Spa 5*",
                        "price": 180000,
                        "price_formatted": "от 180,000 ₸",
                        "price_usd": 400,
                        "departure": townfrom,
                        "duration": f"{nights} ночей",
                    ...
                    },
                    {
                        ...
                        "meal": "Завтрак",
                        "adults": adults,
                        "description": "Незабываемый отдых в сердце Дубая",
                        "available": True,
                        "rating": 4.9
                    },
                    {
                        ...
                        "hotel": "Four Seasons Resort Sharm El Sheikh 5*",
                        "price": 150000,
                        "price_formatted": "от 150,000 ₸",
                        "price_usd": 333,
                        "departure": townfrom,
                        "duration": f"{nights} ночей",
                        ...
                        "meal": "All Inclusive",
                        "adults": adults,
                        "description": "Дайвинг и отдых на Красном море",
                        "available": True,
                        "rating": 4.7
                    },
                    {
                        "id": "TR004",
                        "name": "Мальдивы - Мале",
                        "hotel": "Conrad Maldives Rangali Island 5*",
                        "price": 350000,
                        "price_formatted": "от 350,000 ₸",
                        "price_usd": 778,
                        "departure": townfrom,
                        "duration": "6 ночей",
                        ...
                        "meal": "Полный пансион",
                        "adults": adults,
                        "description": "Райский отдых в водных виллах",
                        "available": True,
                        "rating": 5.0
                    },
                    {
                        "id": "TR005",
                        "name": "Греция - Крит",
                        "hotel": "Blue Palace Resort & Spa 5*",
                        "price": 190000,
                        "price_formatted": "от 190,000 ₸",
                        "price_usd": 422,
                        "departure": townfrom,
                        "duration": f"{nights} ночей",
                        ...
                        "meal": "Полупансион",
                        "adults": adults,
                        "description": "Исторические достопримечательности и пляжный отдых",
                        "available": True,
                        "rating": 4.6
                    }
                ],
                ...
                "search_params": {
                    ...
                    "adults": adults,
                    "nights": nights,
                    "checkin": data.get('checkin', "2025-09-15"),
                    "checkout": data.get('checkout', "2025-09-22")
                },
                "server_info": {
                    "ready_for_deployment": True,
                    "target_server": "vmi2118687.contaboserver.net",
                    "ip_status": "white_listed",
                    "api_format": "correct"
                },
                "timestamp": datetime.now().isoformat(),
                "message": "🎯 ДЕМО: Система готова для развертывания на сервере с белым IP"
            }
            
            logger.info(f"Demo search success for {townfrom}: {len(demo_response['tours'])} tours returned")
            return jsonify(demo_response)
            
        except Exception as e:
            logger.error(f"Demo search error: {str(e)}")
